...
if __name__ == '__main__':
    ...
    solid_map_plot(omegas1, [pmin, pmax], [qmin, qmax], 'Vector potential', 'map_solidAngle1.eps')
    solid_map_plot(omegas2, [pmin, pmax], [qmin, qmax], 'Double geometric integral', 'map_solidAngle2.eps')
    solid_map_plot(omegas3, [pmin, pmax], [qmin, qmax], 'Single geometric integral', 'map_solidAngle3.eps')
